  ...
  return (
    <>
      ...
      <div className="flex">
          ...
          <div className="flex flex-col justify-center gap-4 w-full py-16 bg-[#efefef] pl-20 pr-20">
            <div className="">
              <p className="text-black">
                É um parasita em massa e liberador de ovos, usado principalmente
                para o controle de pragas. Com ele é possível lançar insumos
                biológicos como Trichogramma, Telenomus e Chrysopa (todos
                testados e em operação comercial com DRONES no Brasil, Colômbia
                e América Central).
              </p>
            </div>
        ...
        <div className="h-full w-1/3 bg-[#efefef]"></div>
      </div>
...
function Feature({ src, description }: { src: string; description: string }) {
  return (
...
function DroneCard({ src, description }: { src: string; description: string }) {
  return (
...
function BiologicCard({ src, name }: { src: string; name: string }) {
  return (
...
function HarvestCard({ src, name }: { src: string; name: string }) {
  return (
